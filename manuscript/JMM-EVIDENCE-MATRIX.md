...
| Alternative source route | Strict direct preparation from RCSB mmCIF produced 26 successes in 102 attempts; all remaining outcomes and reasons must be reported. | `results/rcsb_mmcif_preparation_audit.csv` | Full rerun completed but was non-identical at one time-sensitive record (2I78); see `reports/INDEPENDENT-MMCIF-REPRODUCTION-2026-08-09.md`. | Not a claim that mmCIF universally resolves receptor preparation. |
