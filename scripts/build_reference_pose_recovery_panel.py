...
def main():
 ...
 with (root/'results'/'reference_pose_recovery_panel.csv').open('w',newline='',encoding='utf-8') as h:w=csv.DictWriter(h,fieldnames=list(rows[0]));w.writeheader();w.writerows(rows)
